...
(defface whitespace-hspace		; 'nobreak-space
  '((((class color) (background dark))
    ...
    (((class color) (background light))
     ...
     ;;(:background "darkgray" :foreground "lightgray"))
    (t (:inverse-video t)))
...
(defcustom whitespace-display-mappings
  (if (>= emacs-major-version 23)
    ...
    ;; unicode merging.
    '(
      (space-mark   ?\     [?\u2423]     [?.]) ; space - centered dot; EDIT: underscore
      ...
      (space-mark   ?\xF20 [?\xF24]      [?_]) ; hard space - currency
      ;; NEWLINE is displayed using the face `whitespace-newline'
      ;; (newline-mark ?\n    [?\x3e ?\n])	; eol - dollar sign; EDIT: closing angle bracket
      ;; (newline-mark ?\n    [?\u21B5 ?\n] [?$ ?\n])	; eol - downwards arrow
      ;; (newline-mark ?\n    [?\xB6 ?\n]   [?$ ?\n])	; eol - pilcrow
      ;; (newline-mark ?\n    [?\x8AF ?\n]  [?$ ?\n])	; eol - overscore
      (newline-mark ?\n    [?\x8AC ?\n]  [?$ ?\n])	; eol - negation
      ...
      ;; the next TAB column.
      ;; If this is a problem for you, please, comment the line below.
      (tab-mark     ?\t    [?\u00BB ?\t]   [?\\ ?\t]) ; tab - left quote mark EDIT: guillemet
      ))
